...
<template>
  <div class="flex justify-center mt-30">
    <fieldset class="fieldset bg-base-200 border-base-300 rounded-box w-xs border p-4">
      <legend class="fieldset-legend">Register a new account to Tiantian</legend>
      ...
      <div class="flex justify-end">
        <RouterLink :to="{name:'user-account-login-index'}" class="btn btn-sm btn btn-ghost text-gray-500">
          登录
        </RouterLink>
      </div>
    </fieldset>
